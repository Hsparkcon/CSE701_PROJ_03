...
/**
 * @brief
 * M_ESTIMATOR_LOGISTIC class implements weight function (pure virtual) of REGRESSION_ROBUST with Huber M-Estimator.
 * M_ESTIMATOR_LOGISTIC class contains tunning constant for Huber M-Estimator.
 *
 */
...
public:
    /**
     * @brief Constructs ROBUST_REGRESSION object with weight function driven from Huber M-Estimator.
     *
