...
/**
 * @brief
 * M_ESTIMATOR_WELSCH class implements weight function (pure virtual) of REGRESSION_ROBUST with Welsch estimator.
 * M_ESTIMATOR_WELSCH class contains tunning constant for Welsch estimator.
 *
 */
...
public:
    /**
     * @brief Constructs ROBUST_REGRESSION object with weight function driven from Welsch estimator.
     *
